...
class WebserviceUserProvider implements UserProviderInterface  
{
    ...
    public function refreshUser(UserInterface $user)
    {
        ...
        return $this->fetchUser($username,$country_code,$phone_number);
    }
    ...
    private function fetchUser($username,$country_code,$phone_number)
    {
        var_dump($username,$country_code,$phone_number);
       ...
       $endpoint="secure/login";
        ...
        if ($userData) {
            ...
            return  new WebserviceUser($phone_number ,$country_code,$password  ,$salt, $roles);
